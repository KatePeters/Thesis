...
savepath = '/Volumes/KPMSB352/Thesis/Chapter 6 - Photometry TH Cre VTA/Figures'
...
for filename in TDTfiles_cTHPH_lick:
...
fig.savefig('/Volumes/KPMSB352/Thesis/Chapter 6 - Photometry TH Cre VTA/Figures/AllRatsAllRuns.pdf', bbox_inches="tight")
...
for filename in TDTfiles_cTHPH_dis:
...
fig.savefig('/Volumes/KPMSB352/Thesis/Chapter 6 - Photometry TH Cre VTA/Figures/Distractors_All_Rats.pdf', bbox_inches="tight")
...
fig.savefig('/Volumes/KPMSB352/Thesis/Chapter 6 - Photometry TH Cre VTA/Figures/Distracted_All_Rats.pdf', bbox_inches="tight")
...
# EDIT THIS TEXT TO SHOW NUMBER OF TOTAL DISTRACTORS OR TRIALS ON THE AVERAGED PLOT 
#plt.text(250,0.03, '{}'.format(len(MergedRunList_Long)) + ' Long Runs' ) ## Edit this to be all
fig.savefig('/Volumes/KPMSB352/Thesis/Chapter 6 - Photometry TH Cre VTA/Figures/NotDistracted_All_Rats.pdf', bbox_inches="tight")
